...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between px-4 sm:px-[10%] text-sm text-primary py-2 fixed top-0 left-0 right-0 bg-white border-b border-b-gray-400">
